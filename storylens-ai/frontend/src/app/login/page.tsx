...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-white to-primary-100/60 px-4 dark:from-slate-950 dark:via-slate-900 dark:to-accent-950/40">
      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Sign in to continue to StoryLens AI
          </p>
        </div>
